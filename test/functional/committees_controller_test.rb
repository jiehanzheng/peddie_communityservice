...
class CommitteesControllerTest < ActionController::TestCase
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post :create, committee: { description: @committee.description, location: @committee.location, name: @committee.name, user_id: @committee.user_id }
    end
  ...
  test "should update committee" do
    put :update, id: @committee, committee: { description: @committee.description, location: @committee.location, name: @committee.name, user_id: @committee.user_id }
    assert_redirected_to committee_path(assigns(:committee))
  end
